...
export function NovoContatoManual({ onCreated }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    setError("")
    if (!form.nome_empresa && !form.razao_social) {
    ...
    try {
      ...
      if (form.capital_social) body.capital_social = parseFloat(form.capital_social)
      if (form.valor) body.valor = parseFloat(form.valor)
      if (form.eh_mei !== "") body.eh_mei = form.eh_mei === "true"
      if (form.optante_simples !== "") body.optante_simples = form.optante_simples === "true"
